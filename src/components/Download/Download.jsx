...
export default () => (
    <div className="DownloadBack">
        <div className="Desktop_centered">
            <h1 className="desktop_title">ZingyTrader For Your Desktop</h1>
            ...
            <div className="Desktop_description">
                ...
                <div className="description-block">
                    ...
                    <div className="description-text">
                        ZingyTraderis a web app that runs in the browser. Downloading is not required to use
                        ZingyTrader. In both the web and desktop version, keys are never sent to any server and
                ...
                <div className="description-block">
                    ...
                    <div className="description-text">
                        ...
                        code to run ZingyTrader is self contained in the downloads, though it does not run a Stellar
