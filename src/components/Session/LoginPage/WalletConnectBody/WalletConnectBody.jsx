            ...
            <div className="LoginPage_row-content">
                <div className="LoginPage__body">
                    ...
                    <div className="LoginPage__header">
                        <div className="LoginPage__header-wrap">
                            ...
                            <span className="LoginPage__intro">
                                Use LifeTrader with WalletConnect-compatible app
                            </span>
                        </div>
                    ...
                    <a
                        ...
                        href="https://stellarterm.freshdesk.com/support/solutions/articles/151000012438-walletconnect-how-do-i-log-in-to-LifeTrader-with-my-wallet-app"
                        target="_blank"
