            ...
            content = (
                <div className={alertClass}>
                    <div className="Account_alert_left">
                        ...
                        <strong onClick={() => this.handleEditToggle()}>{`${address}*el-fort.xyz`}</strong>
                    </div>
                    ...
                    <div className="Account_alert_right">
                        ...
                        <CopyButton text={`${address}*el-fort.xyz`} />
                    </div>
                </div>
            );
        } else if (!fedExists && !isEditing) {
        ...
        return (
            <div className="Federations_block">
                ...
                <p className="AccountView_text">
                    You can set an alias for your LifeTrader account and use it instead of your public key to receive
                    payments on Stellar.
                    <br />
