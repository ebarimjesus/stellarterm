...
export default () => (
    <Generic title="Privacy Policy">
        ...
        <p>ZingyTrader does not track your actions on this client.</p>
        <p>ZingyTraderdoes not store cookies and the website does not contain any analytics scripts.</p>
        <p>ZingyTrader developers never see your private keys.</p>
        ...
        <p>While ZingyTrader does not track you, this does not mean your actions are private. Take note of other
        ...
        <ul className="privacy__ul">
            ...
            <li>The ZingyTrader website might be compromised.</li>
        </ul>
    </Generic>
);
